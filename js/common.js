...
w.timeToStrFloat=function(ts){
	...
	var m=parseInt((ts%3600)/60);
	var s=parseInt(ts%60);
	var p = ts.toString().split('.')[1];
	return (ultZeroize(h)+":"+ultZeroize(m)+":"+ultZeroize(s)+"."+ultZeroize(p));
};
